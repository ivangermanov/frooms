...
Developed an interactive room reservation system.

- **PWA**: Developed an interactive room reservation system as a Progressive Web App (PWA) using Vue and Nuxt.js.
- **Dynamic Map**: Implemented a dynamic map for room reservations with LeafletJS.
